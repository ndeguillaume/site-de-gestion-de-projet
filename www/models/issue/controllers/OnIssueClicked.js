    ...
    if (issue.classList.contains('dropped')) {
      ...
      window.$.get(
        ...
        function (returnedData) {
          ...
          document.querySelector('.issue-information .issue-id').innerText = returnedData[0]
          ...
          document.querySelector('.issue-information-cost').value = '1'
...
function buttonClickListener () {
  if(document.querySelector('.issue-information-cost').value === "") {
    document.querySelector('.issue-information-cost').style.boxShadow = '0 0 3px 2px red'
  }
  else {
  window.$.put(
    ...
    {},
    function (returnedData) {
      document.querySelector('.issue-information-cost').style.boxShadow = 'none'
      location.reload()
    }
  )
  }
