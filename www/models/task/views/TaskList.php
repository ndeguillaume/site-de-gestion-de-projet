    ...
    <div class="container-fluid">
        <div class="row">
            <div class="backlog-content col-12">
                ...
                $active_sprint_issues = $issues->getIssuesBySprint($active_sprint['id']);
                if (is_array($active_sprint_issues) || is_object($active_sprint_issues)) {
                    foreach ($active_sprint_issues as $sprint_issue) {
                        $issue = new Issue($db);
