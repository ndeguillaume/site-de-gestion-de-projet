  ...
  function (button) {
    button.addEventListener(
      ...
      function () {
        ...
        const headerNode = document.createTextNode("Supprimer l'task " + taskId + '?')
        const bodyContent = document.createElement('p')
        const bodyNode = document.createTextNode("Vous allez définitivement supprimer l'task suivante : \n" + taskTitle)
