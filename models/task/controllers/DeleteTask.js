document.querySelectorAll(".delete-task").forEach(function(button){
    button.addEventListener("click",function(){
        ...
        let task_id = this.nextSibling.innerHTML;
        let task_title = this.nextSibling.nextSibling.innerHTML;
        let header_node = document.createTextNode("Supprimer l'task "+task_id+"?");
        let body_content = document.createElement("p");
        let body_node = document.createTextNode("Vous allez définitivement supprimer l'task suivante : \n"+task_title);
        ...
        delete_button.addEventListener("click", function(e) {
            $.delete('../controllers/DeleteTask.php?id=' + task_id, {}, 
