document.querySelectorAll(".end-sprint").forEach(function(button){
    button.addEventListener("click",function(){
        ...
        console.log(this.previousSibling.previousSibling.className);
        let sprint_title = this.previousSibling.previousSibling.innerText;
        let header_node = document.createTextNode("Terminer le sprint "+sprint_id+"?");
        let body_content = document.createElement("p");
        let body_node = document.createTextNode("Vous allez terminer le sprint suivant : \n"+sprint_title);
        let delete_button = document.createElement("button");
        let cancel_button = document.createElement("button");
        delete_button.innerHTML = "Terminer";
        ...
        delete_button.addEventListener("click", function(e) {
            modal.style.display = "none";
            // $.delete('../../sprint/controllers/EndSprint.php?id=' + sprint_id, {}, 
